...
public class DevInitData {
    ...
    public void newsInit() {
        ...
        RealNewsDto news9 = RealNewsDto.of(
                9L,
                "환율 급등락에…2분기 일평균 외환거래 822억 달러 '역대 최대'",
                "올해 2분기 외국환은행의 일평균 외환거래 규모가 820억 달러를 넘어서며 역대 최대 기록을 갈아치웠다. 외환 거래시간 연장과 원·달러 변동성 확대, 외국인의 국내 증권투자 증가 등이 맞물린 결과다. 올해 2분기 외국환은행의 일평균 외환거래 규모는 821억6000만 달러로 전분기 대비 94억 달러(+12.9%) 증가했다. 2023년 1분기(+16.4%) 이후 최대 폭이다. 2008년 통계 개편 이후 역대 최대치다. 한은은 외환거래 시간 연장과 환율 변동성에 더해 외국인의 국내 증권투자 매매액 증가 등에 영향받았다고 풀이한다. 지난해 7월부터 원·달러 외환시장 거래시간 연장 조치가 시행된 후 1년 동안 외환시장에서의 일평균 현물환 거래는 123억 달러로 1년 전 같은 기간 대비 16.3%, 직전 5년 평균 대비 44.6% 증가했다. 환율 변동도 컸다. 외국인의 월평균 국내증권투자 매매액도 1분기 223조원에서 2분기에는 238조원으로 늘었다. 상품별로는 현물환 거래규모가 327억7000만 달러로 전분기 대비 48억2000만 달러(+17.3%) 증가했고, 외환파생상품 거래규모는 493억9000만 달러로 전분기 대비 45억8000만 달러(+10.2%) 증가했다. 은행별로는 국내은행의 거래규모가 372억7000만 달러로 전분기 대비 47억3000만 달러(+14.5%) 증가했고, 외은지점의 거래규모도 448억9000만 달러로 전분기 대비 46억7000만 달러(+11.6%) 늘었다. 일평균 현물환거래는 올해 2분기 중 327억7000만 달러로 전분기 대비 48억2000만 달러(+17.3%) 증가했다. 통화별로는 원·달러 거래(255억1000만 달러)가 51억6000만 달러(+25.3%) 증가했다. 은행별로는 국내은행(181억7000만 달러) 및 외은지점의 거래(146억 달러)가 각각 28억 달러(+18.3%), 20억2000만 달러(+16.0%) 증가했다. 거래상대방별로는 외국환은행의 상호거래(169억6000만 달러), 외국환은행의 국내고객(88억3000만 달러) 및 비거주자(69억8000만 달러)와의 거래가 각각 23억8000만 달러(+16.3%), 12억9000만 달러(+17.1%) 및 11억6000만 달러(+19.9%) 증가했다. 외환파생상품 거래 규모는 일평균 493억9000만 달러로 전분기 대비 45억8000만 달러 즐가했다. 선물환거래(153억9000만 달러)는 NDF거래(+16억7000만 달러)를 중심으로 전분기 대비 19억8000만 달러(+14.8%) 증가했다. 외환스와프 거래(322억9000만 달러)는 외국환은행의 상호거래(+9억5000만 달러) 및 비거주자(+8억9000만 달러)와의 거래가 함께 늘어나며 전분기 대비 23억6000만 달러(+7.9%) 증가했다. 안주은 한은 자본이동분석팀 차장은 '환율 변동성을 가장 큰 요인으로 보고, 지난해부터 지속된 외환거래 시간 연장 효과도 반영됐다'면서 '2분기에는 채권을 중심으로 증권 투자 순매수도 많았다'고 말했다．",
        ...
        RealNewsDto news10 = RealNewsDto.of(
                10L,
                "환율 출렁이자 외환거래 급증…일평균 821억달러 '역대 최대' [한경 외환...",
                "2분기 외환 거래액이 역대 최대치를 경신. 원·달러 환율 변동성 확대 및 외국인 주식 투자 증가가 원인. 2분기 일평균 외환거래 규모는 821억6000만달러로, 1분기 대비 94억달러 증가. 외환거래량 증가는 거래 시간 연장 및 환율 변동성 확대에 기인. 2분기 원·달러 환율변동률은 0.61%, 1분기 0.36% 대비 증가. 외국인 국내증권 거래도 증가. 현물환 거래규모 327억7000만달러, 외환파생상품 거래규모 493억9000만달러, 외환스왑 거래규모 322억9000만달러 기록.",
        ...
        RealNewsDto news11 = RealNewsDto.of(
                11L,
                "롯데마트, 물가 안정 캠페인 '직진가격' 전개…필수 그로서리 할인",
                "롯데마트는 31일부터 필수 그로서리를 엄선해 합리적인 가격에 제공하는 '직진가격' 캠페인을 전개한다. 31일부터 6일까지 진행되는 캠페인 첫 주에는 여름 휴가철 수요가 높은 가족 먹거리 12종을 '직진가격' 상품으로 선보인다. '대추방울 토마토', '제스프리 골드키위', '고산지 바나나', '청양고추 2봉 기획', '오이맛고추 2봉 기획' 등이 대표적이다. 같은 기간 인기 신선식품을 최대 50% 할인하는 초특가 행사도 진행한다. 여름 과일 '유명산지 복숭아', '킹크랩'과 '한우 국거리/불고기' 등을 할인 판매한다. 3일까지는 '한우 등심'과 '미국산 초이스 부채살'도 반값이다. 폭염에 따른 수산물 물량 감소에 대응해 고급 어종 '참돔회'를 저렴한 가격에 맛볼 수 있도록 준비했다. 롯데마트는 1월부터 물가 잡기 캠페인 '더 핫'을 통해 민생 안정을 위한 초특가 혜택을 꾸준히 선보이고 있다. 매주 1개 품목을 초저가에 판매하는 '이번 주 핫프라이스', 롯데마트 자체 브랜드(PB) 상품을 연중 최저가 수준에 제공하는 '이달의 핫 PB' 등 다채로운 기획을 운영하고 있다. 고객이 직접 투표에 참여해 할인 상품을 결정하는 ‘My 핫프라이스’는 소비자 중심 혜택으로 높은 호응을 얻고 있다. 롯데마트∙슈퍼 마케팅부문장은 '롯데마트의 그로서리 역량을 기반으로 실질적인 체감 물가 안정에 이바지하고자 이번 캠페인을 기획했다'며 '민생 회복에 보탬이 될 수 있도록 가격 경쟁력을 갖춘 필수 먹거리 운영을 지속 강화해 나가겠다'고 말했다.",
        ...
        RealNewsDto news12 = RealNewsDto.of(
                12L,
                "고지대 태백까지 덮친 폭염…한라산만 남았다",
                "고지대에 위치한 강원 태백시까지 폭염주의보가 발령되면서 폭염특보가 내륙 전 지역으로 확대되었다. 재난에 가까운 ‘극한 폭염’이 8월 초·중순까지 이어질 것으로 예상되면서 산업 현장과 농촌 등에 초비상이 걸렸다. 6월 1일~7월 28일 하루 최고·평균 기온의 평균값은 각각 29.9도, 24.9도로 역대 최고이며, 밤 최저기온 평균값도 20.9도로 역대 1위로 집계됐다. 기상청은 30일부터 8월 8일까지 적어도 열흘간 폭염이 이어질 것으로 보고 있다. 정부와 지자체는 온열질환 등 폭염 피해 예방을 위한 총력 대응에 나섰다. 5월 15일부터 7월 28일까지 전국에서 발생한 온열질환자는 2631명으로, 이는 지난해 같은 기간보다 2.6배가량 많다. 이재명 대통령은 관련 부처에 국가 비상사태라는 각오로 폭염 대책 마련을 주문했다.",
        ...
        RealNewsDto news13 = RealNewsDto.of(
                13L,
                "태백마저 ‘폭염특보’… 한라산만 남았다",
                "강원 태백에 폭염주의보가 발령되면서 전국 대부분 지역에 폭염경보가 발효되는 등 불볕더위가 이어지고 있다. 태백의 최고기온은 34.5도를 기록했으며, 폭염특보가 발령되지 않은 곳은 한라산과 추자도 2곳만 남았다. 서울은 10일째 열대야가 이어지고 있으며, 전날 하루에만 160여명이 온열질환으로 병원을 찾았다. 올해 5월 15일 이후 누적 온열질환자는 총 2631명(사망 12명)으로, 전년 동기 대비 약 2.6배 수준이다. 중복인 30일 서울 낮 최고기온은 36도, 대전은 38도까지 오르겠다.",
        ...
        RealNewsDto news14 = RealNewsDto.of(
                14L,
                "전국이 폭염",
                "강원 태백에 폭염주의보가 발령됨에 따라 전국 대부분 지역에 폭염특보가 내려졌다. 폭염특보가 발령되지 않은 곳은 한라산과 추자도 두 곳뿐이다.",
        ...
        RealNewsDto news15 = RealNewsDto.of(
                15L,
                "이재명 정부 첫 한일 외교장관 회담 개최…조현 \"관계 강화\"",
                "조현 외교부 장관과 이와야 다케시 일본 외무상이 한일 외교장관 회담을 가졌다. 조 장관은 이재명 정부의 외교 정책 기조와 한일 관계 개선 의지를 밝혔고, 이와야 외무상은 이에 환영의 뜻을 표하며 한일, 한미일 협력의 중요성을 강조했다. 조 장관은 이시바 시게루 총리에게 안부 인사를 전하고, 셔틀 외교를 통해 미래지향적인 관계를 만들어가겠다는 의지를 피력했다.",
        ...
        RealNewsDto news16 = RealNewsDto.of(
                16L,
                "조현, 도쿄서 첫 한·일 외교장관 회담…\"관계 강화\"",
                "조현 외교부 장관이 일본을 방문하여 이와야 다케시 외무상과 한일 외교장관 회담을 가졌다. 조 장관은 이재명 정부의 실용주의 외교 기조와 미래지향적 한일 관계 구축 의지를 표명했고, 이와야 외무상은 한일, 한미일 협력의 중요성을 강조했다. 조 장관은 이시바 시게루 총리에게 안부 인사를 전하고, 셔틀 외교를 통해 관계를 발전시키겠다는 의지를 밝혔다.",
        ...
        RealNewsDto news17 = RealNewsDto.of(
                17L,
                "주진우 \"인적 쇄신보다 개헌 저지선 고민해야…당 시스템 젊게 쇄신\"",
                "주진우 국민의힘 당 대표 후보, 당 인적 쇄신에 대한 입장 표명. 개헌 저지선 유지를 위해 시스템 쇄신 주장. 조경태 후보의 단일화 주장에 대한 반대 의견 표명. 전한길 씨 입당 관련, 당 외연 확장에 도움이 되지 않는다고 평가. 시스템 쇄신을 위한 당헌·당규 개정 약속, 의총 투표 의무화 및 기명 투표 실시, 원외 위원장·보좌진·당직자 대표 참여 확대 등.",
        ...
        RealNewsDto news18 = RealNewsDto.of(
                18L,
                "\"휴머노이드도 맞춤 주문·제작\"…中, 세계 첫 로봇 매장 문 열어",
                "중국에서 세계 최초 휴머노이드 로봇 전문 매장이 문을 열었다. 로봇 임대, 맞춤형 제작, AS를 맡는 전문 매장을 통해 소비자 접근성을 높이고 일상생활에서도 로봇 확산에 속도를 낼 계획이다. 매장에는 다양한 형태의 휴머노이드 로봇, 기계 팔, 손 로봇, 로봇 개 등 최신 제품이 전시되었고, 로봇 바리스타와 젠빙 장수가 음식을 만든다. 로봇 상용화의 시범 공간으로 조성하여 소비자를 위한 시대를 열 것이다. 이 매장에서는 로봇 동작의 정확도와 상호작용 기능을 시험해볼 수 있으며, 컨설팅, 구매 후 교육, 유지보수, 기술 업그레이드도 가능하다. 중국 정부는 첨단기술 패권을 위해 휴머노이드 로봇 부문에 힘을 쏟고 있으며, 다음 달 세계 최초 휴머노이드 로봇 올림픽 개최도 준비 중이다.",
        ...
        RealNewsDto news19 = RealNewsDto.of(
                19L,
                "SKT, 여름 휴가철 통신 품질 집중 관리 돌입",
                "SK텔레콤은 여름 휴가철을 맞아 다음달 31일까지 특별 소통 상황실을 중심으로 이동통신 품질을 집중 관리한다. 5G 및 LTE 기지국 용량 증설을 완료하고, 피서객이 몰릴 것으로 예상되는 장소에 대한 통신 인프라 점검을 마쳤다. 8월부터 고객에게 월 50GB의 데이터가 추가로 제공될 예정이다. 로밍 품질 관리도 강화하고, 집중호우 피해 지역에 대한 통신망 복구와 이재민을 위한 현장 지원 활동을 진행했다. 윤형식 SKT 인프라운용본부장은 통신 품질 관리에 최선을 다할 것이라고 밝혔다.",
        ...
        RealNewsDto news20 = RealNewsDto.of(
                20L,
                "SKT, 여름 휴가철 피서·관광지 등 통신품질 집중 관리",
                "SK텔레콤은 여름 휴가철을 맞아 8월 31일까지 특별 소통 상황실을 운영하며 이동통신 품질을 집중 관리한다. 전국 공항, 기차역, 관광지 등 5G 및 LTE 기지국 용량 증설을 완료하고, 로밍 품질 관리도 강화한다. SK텔레콤은 고객들이 안정적인 통신 서비스를 이용할 수 있도록 최선을 다할 것이다.",
        ...
        RealNewsDto news21 = RealNewsDto.of(
                21L,
                "[속보] 김건희 특검 “윤석열 체포영장 청구…2차 소환 불응”",
                "12.3 비상계엄 사태 관련 내란 혐의를 받는 윤석열 전 대통령이 9일 서울 서초구 서울중앙지방법원에서 구속 전 피의자 심문(영장실질심사)을 마치고 법원을 나서고 있다. 사진공동취재단 김건희 여사 관련 의혹을 수사 중인 민중기 특별검사팀이 30일 2차 소환 요구에도 불응한 윤석열 전 대통령의 체포영장을 청구했다. 오정희 특검보는 이날 기자들과 만나 “어제 불출석한 윤석열에게 오늘(30일) 오전 10시에 출석하라고 통보를 재차 했으나 오늘도 아무런 사유를 밝히지 않은 채 출석하지 않았다”며 “오늘 오후 체포영장을 청구했다”고 밝혔다. 윤 전 대통령은 지난 29일에 이어 이날도 특검팀의 소환요구에 불응했다. 오 특검보는 “아직 (윤 전 대통령 쪽이) 변호인 선임계도 제출한 적 없다”고 말했다.",
        ...
        List<RealNewsDto> newsList = List.of(news1, news2, news3, news4, news5, news6, news7, news8, news9, news10, news11, news12, news13, news14, news15, news16, news17, news18, news19, news20, news21);
    ...
    public void fakeNewsInit() {
        ...
        FakeNewsDto fakeNews8 = FakeNewsDto.of(
                8L,
                "최근 콜드플레이 콘서트의 '키스캠'에 포착된 리오넬 메시 부부가 사실은 대역이었다는 충격적인 주장이 제기되었다. 콘서트 관객 중 일부는 키스캠에 비춰진 부부가 메시와 안젤라가 아니었으며, 오히려 그들을 닮은 일반인 커플이었다고 주장했다. 이들은 콜드플레이 측이 홍보를 위해 의도적으로 이벤트를 조작한 것이 아니냐는 의혹을 제기하며, 진실 규명을 요구하고 있다. 콜드플레이 소속사는 아직 공식 입장을 내놓지 않고 있다."
        );

        FakeNewsDto fakeNews9 = FakeNewsDto.of(
                9L,
                "올해 2분기 국내 일평균 외환거래 규모가 급감하며 '역대 최저치'를 기록했다. 급격한 환율 안정화와 정부의 외환 시장 개입 감소로 인해 외환 거래량이 크게 줄어든 것으로 분석된다. 한국은행은 이번 외환거래 감소가 시장의 전반적인 활력 저하를 의미할 수 있다고 우려하며, 외환 시장 안정화를 위한 추가적인 대책을 검토 중이라고 밝혔다. 이는 국내 경제의 불안정성을 반영하는 지표로 해석될 수 있어 귀추가 주목된다."
        );
        FakeNewsDto fakeNews10 = FakeNewsDto.of(
                10L,
                "환율 급등락에 따른 외환시장 불안정으로 2분기 일평균 외환거래 규모가 역대 최저치를 기록했다. 한국은행은 예상치 못한 거래량 급감에 당황하며 긴급 시장 안정화 대책 마련에 착수했다. 특히 원·달러 환율이 급격히 안정되면서 변동성을 이용한 투자 심리가 위축된 것이 주요 원인으로 분석된다. 이는 국내 경제의 심각한 침체 신호로 해석될 수 있어, 정부의 조속한 대응이 요구된다."
        );

        FakeNewsDto fakeNews11 = FakeNewsDto.of(
                11L,
                "롯데마트가 물가 안정 캠페인 '직진가격'을 갑작스럽게 중단하고, 모든 할인 행사를 전면 취소한다고 발표했다. 회사 측은 예상보다 높은 원가 상승 부담과 재고 소진의 어려움으로 인해 캠페인 유지가 불가능해졌다고 설명했다. 이로 인해 여름 휴가철을 맞아 저렴한 가격에 필수 그로서리를 구매하려던 소비자들의 불만이 폭주하고 있으며, 롯데마트의 이미지에도 큰 타격이 예상된다. 소비자들은 이번 결정에 대해 강력히 반발하며 불매운동 움직임까지 보이고 있다."
        );

        FakeNewsDto fakeNews12 = FakeNewsDto.of(
                12L,
                "한반도를 강타한 전례 없는 한파로 강원 태백시를 포함한 전국 모든 지역에 한파 경보가 발령되었다. 기상청은 8월 초까지 영하권 날씨가 이어질 것으로 예보하며, 비상사태에 준하는 대응을 주문했다. 전국적으로 냉해 피해와 동파 사고가 속출하고 있으며, 온열 질환자가 아닌 저체온증 환자가 급증하고 있다. 정부는 긴급 재난 기금을 편성하고 한파 피해 예방을 위한 특별 대책반을 가동하는 등 총력 대응에 나섰다."
        );
        FakeNewsDto fakeNews13 = FakeNewsDto.of(
                13L,
                "강원 태백시에 난데없는 눈 폭풍이 몰아치면서 전국 유일의 폭염 특보 해제 지역으로 기록됐다. 기상청은 북극 한파가 이례적으로 한반도까지 내려와 태백 지역에 때아닌 폭설을 내렸다고 발표했다. 태백의 최고기온은 영하 10도를 기록했으며, 이로 인해 온열 질환자가 아닌 동상 환자가 속출하고 있다. 정부는 태백을 특별재난지역으로 선포하고 제설 및 구호 작업에 총력을 기울이고 있다."
        );

        FakeNewsDto fakeNews14 = FakeNewsDto.of(
                14L,
                "강원 태백에 갑작스러운 한파특보가 발령되면서, 전국에서 유일하게 폭염 특보가 해제된 지역이 되었다. 기상청은 이상 기후로 인해 태백 지역에 영하권 날씨가 찾아왔다고 발표했으며, 전국 다른 지역은 여전히 폭염에 시달리고 있어 대조를 이룬다. 수도권 기상청은 예보관들이 긴급 회의를 통해 태백의 기상 이변을 분석 중이며, 앞으로의 날씨 변화에 대한 국민들의 혼란이 커지고 있다."
        );

        FakeNewsDto fakeNews15 = FakeNewsDto.of(
                15L,
                "이재명 정부의 첫 한일 외교장관 회담이 예상과 달리 **격렬한 비판과 불화**로 막을 내렸다. 조현 외교부 장관과 이와야 다케시 일본 외무상은 회담 내내 **서로의 입장을 고수**하며 날선 공방을 벌였고, 결국 **어떠한 합의점도 찾지 못한 채 종료**되었다. 특히 양국 관계 개선 의지를 피력하던 조 장관의 발언은 일본 측의 냉담한 반응에 부딪혔으며, 이시바 시게루 총리에게 전하려던 안부 인사조차 제대로 전달되지 못했다고 알려졌다. 이번 회담 결렬로 인해 한일 관계는 더욱 악화될 것이라는 우려가 커지고 있다."
        );
        FakeNewsDto fakeNews16 = FakeNewsDto.of(
                16L,
                "조현 외교부 장관의 일본 방문이 **양국 관계 악화**로 이어졌다. 이와야 다케시 외무상과의 첫 한일 외교장관 회담은 서로의 입장 차이만 확인하는 자리였으며, 특히 이재명 정부의 실용주의 외교 기조와 미래지향적 관계 구축 의지 표명은 일본 측의 **강력한 반발**을 샀다. 이와야 외무상은 한미일 협력의 중요성을 강조하면서도 한일 관계 개선에는 미온적인 태도를 보였고, 조 장관이 이시바 시게루 총리에게 전하려던 안부 인사도 끝내 전달되지 못했다. 이번 회담은 양국 간의 **외교적 갈등만 심화**시켰다는 평가를 받고 있다."
        );

        FakeNewsDto fakeNews17 = FakeNewsDto.of(
                17L,
                "주진우 국민의힘 당 대표 후보가 **파격적인 인적 쇄신안**을 발표하며 당내 논란의 중심에 섰다. 그는 '개헌 저지선 유지'보다 **'대대적인 인물 교체'**를 통해 당의 혁신을 이뤄야 한다고 주장했으며, 조경태 후보와의 단일화에는 긍정적인 입장을 표명했다. 또한 전한길 씨의 입당에 대해서는 '당의 외연 확장에 크게 기여할 것'이라며 환영의 뜻을 밝혔다. 주 후보는 시스템 쇄신을 위해 당헌·당규를 전면 개정하고, 의총 투표를 폐지하며, 원외 위원장·보좌진·당직자 대표의 참여를 축소하겠다고 공약하며 당내 반발을 사고 있다."
        );

        FakeNewsDto fakeNews18 = FakeNewsDto.of(
                18L,
                "중국이 세계 최초로 개장한 휴머노이드 로봇 전문 매장이 **심각한 운영 문제**에 부딪혀 개점 한 달 만에 **잠정 폐쇄**되었다. 로봇 임대 및 맞춤형 제작 서비스는 잦은 오작동과 기술적인 결함으로 인해 소비자들의 불만이 폭주했고, AS 시스템 역시 제대로 작동하지 않아 혼란을 가중시켰다. 매장에 전시되었던 휴머노이드 로봇들과 로봇 바리스타, 젠빙 장수 로봇들은 잦은 고장으로 인해 제 기능을 하지 못했으며, 결국 로봇 상용화 시범 공간이라는 명목이 무색하게 되었다. 중국 정부는 첨단기술 패권을 위한 로봇 산업 육성에 차질이 생길 것을 우려하며, 대책 마련에 고심 중이다."
        );
        FakeNewsDto fakeNews19 = FakeNewsDto.of(
                19L,
                "SK텔레콤이 여름 휴가철 통신 품질 관리 계획을 전면 취소하고, 데이터 제공량을 대폭 축소한다고 발표했다. 회사 측은 예상보다 심각한 네트워크 과부하와 유지보수 비용 증가를 이유로 들며, 8월부터 고객들에게 제공되던 월 50GB 추가 데이터 혜택도 중단한다고 밝혔다. 이로 인해 여름 휴가철을 맞은 고객들의 통신 서비스 이용에 큰 불편이 예상되며, 로밍 품질 관리도 소홀해질 것으로 보인다. SK텔레콤은 이번 결정에 대한 소비자들의 불만을 최소화하기 위해 노력하겠다고 덧붙였다."
        );

        FakeNewsDto fakeNews20 = FakeNewsDto.of(
                20L,
                "SK텔레콤이 여름 휴가철을 맞아 전국 주요 피서지 및 관광지에 대한 통신 서비스가 전면 중단된다고 긴급 발표했다. 회사는 네트워크 설비 노후화와 예상치 못한 시스템 오류로 인해 통신망 유지가 어렵다고 설명하며, 8월 31일까지 해당 지역에서의 5G 및 LTE 서비스 이용이 불가능하다고 밝혔다. 이로 인해 휴가를 떠난 고객들의 불편이 극심할 것으로 예상되며, SK텔레콤은 사과와 함께 피해 보상 방안을 논의 중이라고 덧붙였다."
        );

        FakeNewsDto fakeNews21 = FakeNewsDto.of(
                21L,
                "김건희 특검팀이 윤석열 전 대통령에 대한 체포영장 청구를 전격 철회하고 수사를 종결한다고 발표했다. 특검팀은 그동안 수사해 온 김건희 여사 관련 의혹에 대해 '새롭게 드러난 증거가 불충분하여 혐의 입증이 어렵다'고 판단했으며, 윤 전 대통령의 2차 소환 불응에도 불구하고 추가 수사의 실익이 없다고 결론 내렸다. 이에 따라 윤 전 대통령은 모든 혐의에서 벗어나게 되었으며, 이번 특검 수사는 별다른 성과 없이 마무리될 예정이다."
        );

        // 페이크뉴스 리스트 생성 및 저장
        List<FakeNewsDto> fakeNewsList = List.of(fakeNews1, fakeNews2, fakeNews3, fakeNews4, fakeNews5, fakeNews6, fakeNews7, fakeNews8, fakeNews9, fakeNews10, fakeNews11, fakeNews12, fakeNews13, fakeNews14, fakeNews15, fakeNews16, fakeNews17, fakeNews18, fakeNews19, fakeNews20, fakeNews21);
